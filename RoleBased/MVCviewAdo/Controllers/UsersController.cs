...
namespace MVCview.Controllers
{
    public class UsersController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            using (var client = new HttpClient())
            {
                var response = client.GetAsync("https://localhost:7050/api/auth/roles").Result;
        ...
        public async Task<IActionResult> Create(UserDto model)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var response = await client.PostAsJsonAsync(
                    "https://localhost:7050/api/auth/create-user",
                    model);
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var response = await client.DeleteAsync(
                    $"https://localhost:7050/api/auth/delete-user/{id}");
        ...
        public async Task<IActionResult> Edit(UserDto model)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var response = await client.PutAsJsonAsync(
                    $"https://localhost:7050/api/auth/update-user/{model.Id}",
                    model);
